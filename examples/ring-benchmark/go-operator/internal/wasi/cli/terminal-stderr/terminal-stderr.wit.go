...
// Package terminalstderr represents the imported interface "wasi:cli/terminal-stderr@0.2.6".
//
...
import (
	...
	terminaloutput "ring-operator-go/internal/wasi/cli/terminal-output"
)

// TerminalOutput represents the imported type alias "wasi:cli/terminal-stderr@0.2.6#terminal-output".
//
