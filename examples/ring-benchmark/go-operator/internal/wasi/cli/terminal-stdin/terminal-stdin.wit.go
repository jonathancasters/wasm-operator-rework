...
// Package terminalstdin represents the imported interface "wasi:cli/terminal-stdin@0.2.6".
//
...
import (
	...
	terminalinput "ring-operator-go/internal/wasi/cli/terminal-input"
)

// TerminalInput represents the imported type alias "wasi:cli/terminal-stdin@0.2.6#terminal-input".
//
