...
// Package tcp represents the imported interface "wasi:sockets/tcp@0.2.6".
package tcp

import (
	"go.bytecodealliance.org/cm"
	monotonicclock "ring-operator-go/internal/wasi/clocks/monotonic-clock"
	"ring-operator-go/internal/wasi/io/poll"
	"ring-operator-go/internal/wasi/io/streams"
	"ring-operator-go/internal/wasi/sockets/network"
)

// InputStream represents the imported type alias "wasi:sockets/tcp@0.2.6#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:sockets/tcp@0.2.6#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// Pollable represents the imported type alias "wasi:sockets/tcp@0.2.6#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Duration represents the type alias "wasi:sockets/tcp@0.2.6#duration".
//
// See [monotonicclock.Duration] for more information.
type Duration = monotonicclock.Duration

// Network represents the imported type alias "wasi:sockets/tcp@0.2.6#network".
//
// See [network.Network] for more information.
type Network = network.Network

// ErrorCode represents the type alias "wasi:sockets/tcp@0.2.6#error-code".
//
// See [network.ErrorCode] for more information.
type ErrorCode = network.ErrorCode

// IPSocketAddress represents the type alias "wasi:sockets/tcp@0.2.6#ip-socket-address".
//
// See [network.IPSocketAddress] for more information.
type IPSocketAddress = network.IPSocketAddress

// IPAddressFamily represents the type alias "wasi:sockets/tcp@0.2.6#ip-address-family".
//
// See [network.IPAddressFamily] for more information.
type IPAddressFamily = network.IPAddressFamily

// ShutdownType represents the enum "wasi:sockets/tcp@0.2.6#shutdown-type".
//
//	enum shutdown-type {
//		receive,
//		send,
...
// TCPSocket represents the imported resource "wasi:sockets/tcp@0.2.6#tcp-socket".
//
//	resource tcp-socket
