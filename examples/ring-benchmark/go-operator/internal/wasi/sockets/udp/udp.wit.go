...
// Package udp represents the imported interface "wasi:sockets/udp@0.2.6".
package udp
...
// Pollable represents the imported type alias "wasi:sockets/udp@0.2.6#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Network represents the imported type alias "wasi:sockets/udp@0.2.6#network".
//
// See [network.Network] for more information.
type Network = network.Network

// ErrorCode represents the type alias "wasi:sockets/udp@0.2.6#error-code".
//
// See [network.ErrorCode] for more information.
type ErrorCode = network.ErrorCode

// IPSocketAddress represents the type alias "wasi:sockets/udp@0.2.6#ip-socket-address".
//
// See [network.IPSocketAddress] for more information.
type IPSocketAddress = network.IPSocketAddress

// IPAddressFamily represents the type alias "wasi:sockets/udp@0.2.6#ip-address-family".
//
// See [network.IPAddressFamily] for more information.
type IPAddressFamily = network.IPAddressFamily

// IncomingDatagram represents the record "wasi:sockets/udp@0.2.6#incoming-datagram".
//
...
// OutgoingDatagram represents the record "wasi:sockets/udp@0.2.6#outgoing-datagram".
//
...
// UDPSocket represents the imported resource "wasi:sockets/udp@0.2.6#udp-socket".
//
//	resource udp-socket
...
// IncomingDatagramStream represents the imported resource "wasi:sockets/udp@0.2.6#incoming-datagram-stream".
//
...
// OutgoingDatagramStream represents the imported resource "wasi:sockets/udp@0.2.6#outgoing-datagram-stream".
//
