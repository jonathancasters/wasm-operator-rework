...
//go:wasmimport wasi:sockets/udp@0.2.6 [method]udp-socket.stream
//go:noescape
...
//go:wasmimport wasi:sockets/udp@0.2.6 [method]udp-socket.subscribe
//go:noescape
func wasmimport_UDPSocketSubscribe(self0 uint32) (result0 uint32)

//go:wasmimport wasi:sockets/udp@0.2.6 [method]udp-socket.unicast-hop-limit
//go:noescape
func wasmimport_UDPSocketUnicastHopLimit(self0 uint32, result *cm.Result[uint8, uint8, ErrorCode])

//go:wasmimport wasi:sockets/udp@0.2.6 [resource-drop]incoming-datagram-stream
//go:noescape
func wasmimport_IncomingDatagramStreamResourceDrop(self0 uint32)

//go:wasmimport wasi:sockets/udp@0.2.6 [method]incoming-datagram-stream.receive
//go:noescape
...
//go:wasmimport wasi:sockets/udp@0.2.6 [method]incoming-datagram-stream.subscribe
//go:noescape
func wasmimport_IncomingDatagramStreamSubscribe(self0 uint32) (result0 uint32)

//go:wasmimport wasi:sockets/udp@0.2.6 [resource-drop]outgoing-datagram-stream
//go:noescape
func wasmimport_OutgoingDatagramStreamResourceDrop(self0 uint32)

//go:wasmimport wasi:sockets/udp@0.2.6 [method]outgoing-datagram-stream.check-send
//go:noescape
func wasmimport_OutgoingDatagramStreamCheckSend(self0 uint32, result *cm.Result[uint64, uint64, ErrorCode])

//go:wasmimport wasi:sockets/udp@0.2.6 [method]outgoing-datagram-stream.send
//go:noescape
...
//go:wasmimport wasi:sockets/udp@0.2.6 [method]outgoing-datagram-stream.subscribe
//go:noescape
