...
// Package network represents the imported interface "wasi:sockets/network@0.2.6".
package network

import (
	"go.bytecodealliance.org/cm"
	ioerror "ring-operator-go/internal/wasi/io/error"
)

// Error represents the imported type alias "wasi:sockets/network@0.2.6#error".
//
// See [ioerror.Error] for more information.
type Error = ioerror.Error

// Network represents the imported resource "wasi:sockets/network@0.2.6#network".
//
//	resource network
...
// ErrorCode represents the enum "wasi:sockets/network@0.2.6#error-code".
//
//	enum error-code {
//		unknown,
//		access-denied,
...
// IPAddressFamily represents the enum "wasi:sockets/network@0.2.6#ip-address-family".
//
...
// IPv4Address represents the tuple "wasi:sockets/network@0.2.6#ipv4-address".
//
//	type ipv4-address = tuple<u8, u8, u8, u8>
type IPv4Address [4]uint8

// IPv6Address represents the tuple "wasi:sockets/network@0.2.6#ipv6-address".
//
//	type ipv6-address = tuple<u16, u16, u16, u16, u16, u16, u16, u16>
type IPv6Address [8]uint16

// IPAddress represents the variant "wasi:sockets/network@0.2.6#ip-address".
//
//	variant ip-address {
//		ipv4(ipv4-address),
//		ipv6(ipv6-address),
...
// IPv4SocketAddress represents the record "wasi:sockets/network@0.2.6#ipv4-socket-address".
//
...
// IPv6SocketAddress represents the record "wasi:sockets/network@0.2.6#ipv6-socket-address".
//
...
// IPSocketAddress represents the variant "wasi:sockets/network@0.2.6#ip-socket-address".
//
...
// NetworkErrorCode represents the imported function "network-error-code".
//
//	network-error-code: func(err: borrow<error>) -> option<error-code>
//
//go:nosplit
func NetworkErrorCode(err Error) (result cm.Option[ErrorCode]) {
	err0 := cm.Reinterpret[uint32](err)
	wasmimport_NetworkErrorCode((uint32)(err0), &result)
	return
}
