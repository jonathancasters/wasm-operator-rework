...
//go:wasmimport wasi:sockets/tcp@0.2.6 [resource-drop]tcp-socket
//go:noescape
func wasmimport_TCPSocketResourceDrop(self0 uint32)

//go:wasmimport wasi:sockets/tcp@0.2.6 [method]tcp-socket.accept
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.6 [method]tcp-socket.address-family
//go:noescape
func wasmimport_TCPSocketAddressFamily(self0 uint32) (result0 uint32)

//go:wasmimport wasi:sockets/tcp@0.2.6 [method]tcp-socket.finish-bind
//go:noescape
func wasmimport_TCPSocketFinishBind(self0 uint32, result *cm.Result[ErrorCode, struct{}, ErrorCode])

//go:wasmimport wasi:sockets/tcp@0.2.6 [method]tcp-socket.finish-connect
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.6 [method]tcp-socket.start-connect
//go:noescape
...
//go:wasmimport wasi:sockets/tcp@0.2.6 [method]tcp-socket.start-listen
//go:noescape
func wasmimport_TCPSocketStartListen(self0 uint32, result *cm.Result[ErrorCode, struct{}, ErrorCode])

//go:wasmimport wasi:sockets/tcp@0.2.6 [method]tcp-socket.subscribe
//go:noescape
