...
// Package udpcreatesocket represents the imported interface "wasi:sockets/udp-create-socket@0.2.6".
package udpcreatesocket

import (
	"go.bytecodealliance.org/cm"
	"ring-operator-go/internal/wasi/sockets/network"
	"ring-operator-go/internal/wasi/sockets/udp"
)

// Network represents the imported type alias "wasi:sockets/udp-create-socket@0.2.6#network".
//
// See [network.Network] for more information.
type Network = network.Network

// ErrorCode represents the type alias "wasi:sockets/udp-create-socket@0.2.6#error-code".
//
// See [network.ErrorCode] for more information.
type ErrorCode = network.ErrorCode

// IPAddressFamily represents the type alias "wasi:sockets/udp-create-socket@0.2.6#ip-address-family".
//
// See [network.IPAddressFamily] for more information.
type IPAddressFamily = network.IPAddressFamily

// UDPSocket represents the imported type alias "wasi:sockets/udp-create-socket@0.2.6#udp-socket".
//
