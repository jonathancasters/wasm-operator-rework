...
//go:wasmimport wasi:io/streams@0.2.6 [resource-drop]input-stream
//go:noescape
func wasmimport_InputStreamResourceDrop(self0 uint32)

//go:wasmimport wasi:io/streams@0.2.6 [method]input-stream.blocking-read
//go:noescape
...
//go:wasmimport wasi:io/streams@0.2.6 [method]output-stream.blocking-write-and-flush
//go:noescape
...
//go:wasmimport wasi:io/streams@0.2.6 [method]output-stream.blocking-write-zeroes-and-flush
//go:noescape
...
//go:wasmimport wasi:io/streams@0.2.6 [method]output-stream.write-zeroes
//go:noescape
