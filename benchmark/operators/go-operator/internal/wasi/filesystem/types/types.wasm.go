...
//go:wasmimport wasi:filesystem/types@0.2.6 [resource-drop]descriptor
//go:noescape
func wasmimport_DescriptorResourceDrop(self0 uint32)

//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.advise
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.append-via-stream
//go:noescape
func wasmimport_DescriptorAppendViaStream(self0 uint32, result *cm.Result[OutputStream, OutputStream, ErrorCode])

//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.create-directory-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.metadata-hash
//go:noescape
func wasmimport_DescriptorMetadataHash(self0 uint32, result *cm.Result[MetadataHashValueShape, MetadataHashValue, ErrorCode])

//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.metadata-hash-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.open-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.read
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.read-directory
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.rename-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.set-size
//go:noescape
func wasmimport_DescriptorSetSize(self0 uint32, size0 uint64, result *cm.Result[ErrorCode, struct{}, ErrorCode])

//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.set-times
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.set-times-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.stat
//go:noescape
func wasmimport_DescriptorStat(self0 uint32, result *cm.Result[DescriptorStatShape, DescriptorStat, ErrorCode])

//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.stat-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.symlink-at
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [method]descriptor.write-via-stream
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 [resource-drop]directory-entry-stream
//go:noescape
func wasmimport_DirectoryEntryStreamResourceDrop(self0 uint32)

//go:wasmimport wasi:filesystem/types@0.2.6 [method]directory-entry-stream.read-directory-entry
//go:noescape
...
//go:wasmimport wasi:filesystem/types@0.2.6 filesystem-error-code
//go:noescape
