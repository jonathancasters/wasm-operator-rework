...
// Package types represents the imported interface "wasi:filesystem/types@0.2.6".
package types

import (
	"go.bytecodealliance.org/cm"
	wallclock "ring-operator-go/internal/wasi/clocks/wall-clock"
	"ring-operator-go/internal/wasi/io/streams"
)

// InputStream represents the imported type alias "wasi:filesystem/types@0.2.6#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:filesystem/types@0.2.6#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// Error represents the imported type alias "wasi:filesystem/types@0.2.6#error".
//
// See [streams.Error] for more information.
type Error = streams.Error

// DateTime represents the type alias "wasi:filesystem/types@0.2.6#datetime".
//
// See [wallclock.DateTime] for more information.
type DateTime = wallclock.DateTime

// FileSize represents the u64 "wasi:filesystem/types@0.2.6#filesize".
//
//	type filesize = u64
type FileSize uint64

// DescriptorType represents the enum "wasi:filesystem/types@0.2.6#descriptor-type".
//
...
// DescriptorFlags represents the flags "wasi:filesystem/types@0.2.6#descriptor-flags".
//
...
// PathFlags represents the flags "wasi:filesystem/types@0.2.6#path-flags".
//
//	flags path-flags {
//		symlink-follow,
//	}
...
// OpenFlags represents the flags "wasi:filesystem/types@0.2.6#open-flags".
//
//	flags open-flags {
//		create,
//		directory,
...
// LinkCount represents the u64 "wasi:filesystem/types@0.2.6#link-count".
//
//	type link-count = u64
type LinkCount uint64

// DescriptorStat represents the record "wasi:filesystem/types@0.2.6#descriptor-stat".
//
...
// NewTimestamp represents the variant "wasi:filesystem/types@0.2.6#new-timestamp".
//
...
// DirectoryEntry represents the record "wasi:filesystem/types@0.2.6#directory-entry".
//
...
// ErrorCode represents the enum "wasi:filesystem/types@0.2.6#error-code".
//
//	enum error-code {
//		access,
//		would-block,
...
// Advice represents the enum "wasi:filesystem/types@0.2.6#advice".
//
//	enum advice {
//		normal,
//		sequential,
...
// MetadataHashValue represents the record "wasi:filesystem/types@0.2.6#metadata-hash-value".
//
...
// Descriptor represents the imported resource "wasi:filesystem/types@0.2.6#descriptor".
//
//	resource descriptor
...
// DirectoryEntryStream represents the imported resource "wasi:filesystem/types@0.2.6#directory-entry-stream".
//
