...
//go:wasmimport wasi:sockets/ip-name-lookup@0.2.6 [resource-drop]resolve-address-stream
//go:noescape
func wasmimport_ResolveAddressStreamResourceDrop(self0 uint32)

//go:wasmimport wasi:sockets/ip-name-lookup@0.2.6 [method]resolve-address-stream.resolve-next-address
//go:noescape
...
//go:wasmimport wasi:sockets/ip-name-lookup@0.2.6 [method]resolve-address-stream.subscribe
//go:noescape
func wasmimport_ResolveAddressStreamSubscribe(self0 uint32) (result0 uint32)

//go:wasmimport wasi:sockets/ip-name-lookup@0.2.6 resolve-addresses
//go:noescape
