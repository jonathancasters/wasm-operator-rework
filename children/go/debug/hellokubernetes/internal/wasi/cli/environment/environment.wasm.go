...
//go:wasmimport wasi:cli/environment@0.2.6 get-environment
//go:noescape
func wasmimport_GetEnvironment(result *cm.List[[2]string])

//go:wasmimport wasi:cli/environment@0.2.6 get-arguments
//go:noescape
func wasmimport_GetArguments(result *cm.List[string])

//go:wasmimport wasi:cli/environment@0.2.6 initial-cwd
//go:noescape
